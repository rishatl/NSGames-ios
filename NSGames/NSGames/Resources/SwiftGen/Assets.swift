...
internal enum Asset {
  ...
  internal static let noImagePhoto = ImageAsset(name: "NoImagePhoto")
  internal static let selectedHeart = ImageAsset(name: "SelectedHeart")
  internal static let nsGamesIcon = ImageAsset(name: "NSGames-icon")
  internal static let multiplyCircle = ImageAsset(name: "multiply.circle")
  ...
  internal static let onboardingLeftHalf = ImageAsset(name: "OnboardingLeftHalf")
  ...
  internal static let meAnimoji = ImageAsset(name: "me-animoji")
}
